 ...
 *
 * For each of the 495 possible sets of 8 qualifying third-placed groups
 * (sorted, dash-joined), the value is the group letter each group winner
 * faces, indexed by WINNER_SLOTS in the same order.
 *
 * Source: en.wikipedia.org/wiki/2026_FIFA_World_Cup_knockout_stage
 * ("Combinations of matches in the round of 32" table), cross-checked
 * against FIFA Competition Regulations Annex C.
 */

export const WINNER_SLOTS = ["1A","1B","1D","1E","1G","1I","1K","1L"] as const;

export const ANNEX_C: Record<string, [string, string, string, string, string, string, string, string]> = {
